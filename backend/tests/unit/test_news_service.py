...
class TestNewsService:
    ...
    def test_get_news_by_id(self, test_db, sample_news_data):
        ...
        service = NewsService()
        news = service.get_news_by_id("test-news")
        
        assert news is not None
        assert news.id == "test-news"
        assert news.title == "Test Earnings Report"
    
    def test_get_sorted_news(self, test_db, sample_news_data):
        ...
        service = NewsService()
        news_list = service.get_sorted_news(sort_by="date")
    ...
    def test_create_news(self, test_db, sample_news_data):
        """Test creating news"""
        service = NewsService()
        news_id = service.create_news(**sample_news_data)
    ...
    def test_delete_news(self, test_db, sample_news_data):
        ...
        service = NewsService()
        result = service.delete_news("test-news")
